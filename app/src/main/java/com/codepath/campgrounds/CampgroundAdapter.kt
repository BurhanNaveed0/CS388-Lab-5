...
class CampgroundAdapter(private val context: Context, val campgrounds: List<Campground>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        private val nameTextView = itemView.findViewById<TextView>(R.id.cardTitle)
        private val descriptionTextView = itemView.findViewById<TextView>(R.id.cardDescription)
        private val locationTextView = itemView.findViewById<TextView>(R.id.cardLocation)
